...
type PhotoRepository interface {
	...
	FindByID(ctx context.Context, id int) (*domain.GetPhotoResponse, error)
	FindAll(ctx context.Context) (*[]domain.GetPhotoResponse, error)
}
...
type PhotoService interface {
	...
	GetByID(ctx context.Context, id int) (*domain.GetPhotoResponse, error)
	GetAll(ctx context.Context) (*[]domain.GetPhotoResponse, error)
}
