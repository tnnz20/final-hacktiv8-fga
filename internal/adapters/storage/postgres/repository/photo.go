...
func (r PhotoRepository) FindPhotoByID(ctx context.Context, photoId int) (*domain.Photo, error) {
...
func (r PhotoRepository) FindPhotos(ctx context.Context) (*[]domain.Photo, error) {
